package com.example.day5cw3.ashokmodel;

import jakarta.persistence.Entity;
import jakarta.persistence.Id;

@Entity
public class ashokLanguage {
    @Id
    private int languageId;
    private String languageName;
    private String languageComplexity;
    public ashokLanguage() {
    }
    public ashokLanguage(int languageId, String languageName, String languageComplexity) {
