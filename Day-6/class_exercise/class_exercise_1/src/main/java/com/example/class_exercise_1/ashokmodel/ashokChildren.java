package com.example.class_exercise_1.ashokmodel;

import jakarta.persistence.Entity;
import jakarta.persistence.Id;

@Entity
public class ashokChildren {
     @Id
     private int babyId;
     ...
     public ashokChildren() {

     }

     public ashokChildren(int babyId, String babyFirstName, String babyLastName, String fatherName, String motherName,
               String address) {
          this.babyId = babyId;
